...
namespace DoctrineORMModule\Proxy\__CG__\Foleon\V1\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Authors extends \Foleon\V1\Entity\Authors implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Foleon\\V1\\Entity\\Authors' . "\0" . 'id', '' . "\0" . 'Foleon\\V1\\Entity\\Authors' . "\0" . 'name', '' . "\0" . 'Foleon\\V1\\Entity\\Authors' . "\0" . 'books'];
        }
